...
-- Volcando estructura de base de datos para credicel_Mega_Autoventa
CREATE DATABASE IF NOT EXISTS `credicel_Mega_Autoventa` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `credicel_Mega_Autoventa`;

-- Volcando estructura para tabla credicel_Mega_Autoventa.Marca
...
-- Volcando datos para la tabla credicel_Mega_Autoventa.Marca: ~10 rows (aproximadamente)
DELETE FROM `Marca`;
...
-- Volcando estructura para tabla credicel_Mega_Autoventa.Modelo
...
-- Volcando datos para la tabla credicel_Mega_Autoventa.Modelo: ~25 rows (aproximadamente)
DELETE FROM `Modelo`;
...
-- Volcando estructura para tabla credicel_Mega_Autoventa.Sede_Departamento
...
-- Volcando datos para la tabla credicel_Mega_Autoventa.Sede_Departamento: ~5 rows (aproximadamente)
DELETE FROM `Sede_Departamento`;
/*!40000 ALTER TABLE `Sede_Departamento` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `Sede_Departamento` ENABLE KEYS */;

-- Volcando estructura para tabla credicel_Mega_Autoventa.Tipo_Vehiculo
CREATE TABLE IF NOT EXISTS `Tipo_Vehiculo` (
  `Id_Tipo` int(11) NOT NULL AUTO_INCREMENT,
  `Tipo_Vehiculo` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Cantidad` int(11) DEFAULT NULL,
  PRIMARY KEY (`Id_Tipo`),
  UNIQUE KEY `Tipo_Vehiculo` (`Tipo_Vehiculo`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;

-- Volcando datos para la tabla credicel_Mega_Autoventa.Tipo_Vehiculo: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla credicel_Mega_Autoventa.Ventas
...
-- Volcando datos para la tabla credicel_Mega_Autoventa.Ventas: ~100 rows (aproximadamente)
DELETE FROM `Ventas`;
